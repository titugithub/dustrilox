   ...
   <div class="container">
      <div class="row">
         <div class="col-xxl-8 offset-xxl-2 col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
            <?php
            $dustrilox_404_bg = get_theme_mod('dustrilox_404_bg', get_template_directory_uri() . '/<?php echo get_template_directory_uri()?>/assets/img/error/error.png');
            ...
            <div class="error__item text-center">
               <div class="error__thumb mb-45">
                  <img src="<?php echo esc_url($dustrilox_404_bg); ?>" alt="<?php print esc_attr__('Error 404', 'dustrilox'); ?>">
               </div>
