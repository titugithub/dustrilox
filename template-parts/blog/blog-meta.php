...
$dustrilox_blog_date = get_theme_mod( 'dustrilox_blog_date', true );
$dustrilox_blog_comments = get_theme_mod( 'dustrilox_blog_comments', true );
$dustrilox_blog_author = get_theme_mod( 'dustrilox_blog_author', true );
$dustrilox_blog_cat = get_theme_mod( 'dustrilox_blog_cat', false );
