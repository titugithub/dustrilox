<?php 
   ...
   $dustrilox_phone_num = get_theme_mod( 'dustrilox_phone_num', __( '+(088) 234 567 899', 'dustrilox' ) );
               ...
               <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-6 d-none d-lg-block">
                  <div class="header__call d-flex align-items-start">
                     ...
                     <div class="header__call-content">
                        ...
                        <p><a href="mailto:<?php echo esc_attr($dustrilox_mail_id); ?>"><?php echo esc_html($dustrilox_mail_id); ?></a></p>
                        <?php endif; ?> 
                     </div>
                  </div>
               </div>
                  ...
                  <div class="header__bottom-right d-flex justify-content-end align-items-center pl-30">
                     ...
                     <div class="header__login-2 d-none d-md-flex align-items-center ml-20 pl-20">
                        ...
                        <div class="header__login-content">
                           <p><a href="<?php echo esc_html($dustrilox_acc_button_link); ?>"><?php echo esc_html__('Login','dustrilox'); ?></a></p>
                           <p><a href="<?php echo esc_html($dustrilox_acc_button_link); ?>"><?php echo esc_html__('Register','dustrilox'); ?></a></p>
                        </div>
                     </div>
                     <?php endif; ?>
