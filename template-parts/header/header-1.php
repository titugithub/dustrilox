               ...
               <div class="header-info f-right">
                  <?php if (!empty($dustrilox_phone_num)) :   ?>
                     <div class="info-item info-item-right">
                        <span><?php echo esc_html__('Phone Number', 'dustrilex-core') ?></span>
                  ...
                  <?php if (!empty($dustrilox_mail_id)) :   ?>
                     <div class="info-item">
                        <span><?php echo esc_html__('Free Consultancy', 'dustrilex-core') ?></span>
                        <h5><a href="mailto:info@webmail.com"><?php echo esc_html($dustrilox_mail_id) ?></a></h5>
                     </div>
                  <?php endif ?>
               ...
               <div class="row align-items-center">
                  <div class="col-xxl-6 col-xl-8 col-lg-8 col-md-8">
                     <div class="header__info">
                        <ul>
                           <?php if (!empty($dustrilox_mail_id)) : ?>
                              <li>
                                 <a href="mailto:<?php echo esc_attr($dustrilox_mail_id); ?>">
                                    ...
                                    </svg> <?php echo esc_html($dustrilox_mail_id); ?></a>
                              </li>
                           <?php endif; ?>
                           <?php if (!empty($dustrilox_address)) : ?>
                              <li>
                                 <a href="<?php echo esc_html($dustrilox_address_url); ?>" target="_blank">
                                    ...
                                    <?php echo esc_html($dustrilox_address); ?></a>
                              </li>
                           <?php endif; ?>
                        </ul>
                     </div>
                  ...
                  <div class="col-xxl-6 col-xl-4 col-lg-4 col-md-4">
                     <div class="header__top-right d-flex justify-content-end align-items-center">
                        <?php if (!empty($dustrilox_acc_button_text)) : ?>
                           <div class="header__login">
                              <a href="<?php echo esc_html($dustrilox_acc_button_link); ?>"><svg viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 ...
                                 </svg> <?php echo esc_html($dustrilox_acc_button_text); ?></a>
                           </div>
                        <?php endif; ?>

                        <?php if (!empty($dustrilox_button_text)) : ?>
                           <div class="header__btn ml-20">
                              <a href="<?php echo esc_html($dustrilox_button_link); ?>" class="header-btn"><?php echo esc_html($dustrilox_button_text); ?></a>
                           </div>
                        <?php endif; ?>
