...
<main>
      ...
      <div class="slider__active swiper-container">
         <div class="swiper-wrapper">
            <div class="slider__item swiper-slide p-relative slider__height d-flex align-items-center z-index-1">
               <div class="slider__bg slider__overlay include-bg" data-background="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/slider/slider-1.jpg"></div>
               <div class="container">
                  <div class="row">
                     <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-10 col-sm-10">
                        <div class="slider__content p-relative z-index-1">
                           ...
                           <div class="slider__btn" data-animation="fadeInUp" data-delay="1.1s">
                              <a href="https://themepure.net/wp/dustrilox/course-style-01/" class="tp-btn">Find Courses</a>
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="slider__item swiper-slide p-relative slider__height d-flex align-items-center z-index-1">
               <div class="slider__bg slider__overlay include-bg" data-background="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/slider/slider-2.jpg"></div>
               <div class="container">
                  <div class="row">
                  ...
                  <div class="features__item features__border-right d-sm-flex align-items-start white-bg mb-30">
                     <div class="features__icon mr-25">
                        <svg width="42" height="44" viewBox="0 0 42 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                           ...
                           <path d="M7.3176 24.275L7.2966 34.1259C7.2966 36.7934 9.35499 39.6499 11.8755 40.4901L18.5757 42.7165C19.7309 43.0945 21.6423 43.0945 22.8185 42.7165L29.5188 40.4901C32.0392 39.6499 34.0976 36.7934 34.0976 34.1259V24.38" stroke="#3D6CE7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                           <path d="M40.4408 28.3077V15.7054" stroke="#3D6CE7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                     </div>
                     <div class="features__content">
                        <h3 class="features__title">
                           <a href="https://themepure.net/wp/dustrilox/about/">Graduation</a>
                        </h3>
                        <p>Euucal University was established it is recognized.</p>

                        <a href="https://themepure.net/wp/dustrilox/about/" class="link-btn">Learn More <i class="fa-regular fa-arrow-right"></i></a>
                     </div>
                  </div>
               </div>
               <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                  <div class="features__item features__border-right d-sm-flex align-items-start white-bg mb-30">
                     <div class="features__icon mr-25">
                        <svg width="44" height="40" viewBox="0 0 44 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                           <path d="M6.7168 31.4941V18.0775" stroke="#3D6CE7" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                           <path d="M14.3835 31.4941V18.0775" stroke="#3D6CE7" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                           <path d="M22.0501 31.4941V18.0775" stroke="#3D6CE7" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                           <path d="M29.7168 31.4941V18.0775" stroke="#3D6CE7" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                           <path d="M37.3835 31.4941V18.0775" stroke="#3D6CE7" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                     ...
                     <div class="features__content">
                        <h3 class="features__title">
                           <a href="https://themepure.net/wp/dustrilox/about/">University Life</a>
                        </h3>
                        <p>Euucal University was established it is recognized.</p>
                  ...
                  <div class="features__item d-sm-flex align-items-start white-bg mb-30">
                     <div class="features__icon mr-25">
                        <svg width="41" height="38" viewBox="0 0 41 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                           ...
                           <path d="M20.1666 6.41956V35.1696" stroke="#3D6CE7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                           <path d="M12.0209 12.1696H7.70837" stroke="#3D6CE7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                           <path d="M13.4584 17.9196H7.70837" stroke="#3D6CE7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                     </div>
                     <div class="features__content">
                        <h3 class="features__title">
                           <a href="https://themepure.net/wp/dustrilox/about/">Education Services</a>
                        </h3>
                        <p>Euucal University was established it is recognized.</p>
            ...
            <div class="col-xxl-7 col-xl-7 col-lg-7">
               <div class="about__thumb-wrapper d-sm-flex mr-20 p-relative">
                  <div class="about__shape">
                     <img class="about__shape-1 d-none d-sm-block" src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/about/about-shape-1.png" alt="img">
                     <img class="about__shape-2 d-none d-sm-block" src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/about/about-shape-2.png" alt="img">
                     <img class="about__shape-3" src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/about/about-shape-3.png" alt="img">
                  </div>
                  <div class="about__thumb-left mr-10">
                     <div class="about__thumb-1 mb-10">
                        <img src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/about/about-1.jpg" alt="img">
                     </div>
                     <div class="about__thumb-1 mb-10 text-end">
                        <img src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/about/about-3.jpg" alt="img">
                     </div>
                  </div>
                  <div class="about__thumb-2 mb-10">
                     <img src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/about/about-2.jpg" alt="img">
                  </div>
               </div>
            </div>
            <div class="col-xxl-5 col-xl-5 col-lg-5">
               <div class="about__content pl-70 pr-25">
                  <div class="section__title-wrapper mb-15">
                     <span class="section__title-pre">About Educal</span>
                  ...
                  <div class="about__btn">
                     <a href="https://themepure.net/wp/dustrilox/about/" class="tp-btn tp-btn-2">Read more</a>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="row grid">
            <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 grid-item">
               <div class="campus__wrapper">
                  ...
                  <div class="campus__btn mb-80">
                     <a href="https://themepure.net/wp/dustrilox/about/" class="tp-btn tp-btn-border">More Research</a>
                  </div>
               </div>
            </div>
            <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-6 grid-item">
               <div class="campus__thumb w-img mb-30">
                  <img src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/campus/campus-2.jpg" alt="img">
            ...
            <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 grid-item">
               <div class="campus__thumb w-img mb-25">
                  <img src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/campus/campus-3.jpg" alt="img">
               </div>
            </div>
            <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 grid-item">
               <div class="campus__thumb w-img mb-30">
                  <img src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/campus/campus-1.jpg" alt="img">
               </div>
            </div>
            <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 grid-item">
               <div class="campus__thumb w-img mb-30">
                  <img src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/campus/campus-4.jpg" alt="img">
               </div>
            </div>
         </div>
      </div>
   ...
   <section class="research__area research__border grey-bg-3 pt-115 pb-90 p-relative z-index-1">
      <div class="research__shape">
         <img class="research__shape-1 d-none d-sm-block" src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/research/research-shape-1.png" alt="img">
         <img class="research__shape-2 d-none d-sm-block" src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/research/research-shape-2.png" alt="img">
         <img class="research__shape-3" src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/research/research-shape-3.png" alt="img">
      </div>
      <div class="container">
         <div class="row">
            <div class="col-xxl-12">
         ...
         <div class="row">
            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
               <div class="research__item research__item-border text-center mb-30 transition-3">
                  <div class="research__thumb mb-35">
                     <img src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/research/research-1.jpg" alt="img">
                  </div>
            ...
            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
               <div class="research__item research__item-border active text-center mb-30 transition-3">
                  <div class="research__thumb mb-35">
                     <img src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/research/research-2.jpg" alt="img">
                  </div>
                  <div class="research__content">
            ...
            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
               <div class="research__item text-center mb-30 transition-3">
                  <div class="research__thumb mb-35">
                     <img src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/research/research-3.jpg" alt="img">
                  </div>
                  <div class="research__content">
   ...
   <section class="blog__area pt-120 pb-85 p-relative">
      <div class="blog__shape">
         <img class="blog__shape-1" src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/blog/blog-shape-1.png" alt="img">
         <img class="blog__shape-2" src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/blog/blog-shape-2.png" alt="img">
         <img class="blog__shape-3" src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/blog/blog-shape-3.png" alt="img">
         <img class="blog__shape-4" src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/blog/blog-shape-4.png" alt="img">
      </div>
      <div class="container">
         <div class="row">
            <div class="col-xxl-12">
               <div class="section__title-wrapper mb-60 text-center">
                  ...
                  <h2 class="section__title section__title-44">The latest news from Educal</h2>
               </div>
            </div>
         </div>
         <div class="row">
            <div class="col-xxl-6 col-xl-6">
               <div class="blog__item-float blog__item-float-overlay p-relative fix transition-3 mb-30 d-flex align-items-end">
                  <div class="blog__thumb-bg w-img fix" data-background="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/blog/blog-1.jpg"></div>
                  <div class="blog__content-float">
                     <div class="blog__tag-float mb-15">
                        <a href="#">Uncategorized</a>
                     </div>
                     <h3 class="blog__title-float">
                        <a href="https://themepure.net/wp/dustrilox/growing-ux-maturity-in-organizations-education-and-training/">Individual master Courses For degree students.</a>
                     </h3>
            ...
            <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6">
               <div class="blog__item mb-30 white-bg transition-3 mb-30">
                  <div class="blog__thumb w-img fix">
                     <a href="https://themepure.net/wp/dustrilox/growing-ux-maturity-in-organizations-education-and-training/">
                        <img src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/blog/blog-2.jpg" alt="img">
                     </a>
                  </div>
                  <div class="blog__content">
                     ...
                     <h3 class="blog__title">
                        <a href="https://themepure.net/wp/dustrilox/growing-ux-maturity-in-organizations-education-and-training/">How stay calm from the First time.</a>
                     </h3>
            ...
            <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6">
               <div class="blog__item mb-30 white-bg transition-3 mb-30">
                  <div class="blog__thumb w-img fix">
                     <a href="https://themepure.net/wp/dustrilox/growing-ux-maturity-in-organizations-education-and-training/">
                        <img src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/blog/blog-3.jpg" alt="img">
                     </a>
                  </div>
                  <div class="blog__content">
                     <div class="blog__tag">
                     ...
                     <h3 class="blog__title">
                        <a href="https://themepure.net/wp/dustrilox/growing-ux-maturity-in-organizations-education-and-training/">Classroom adapts for the future of learning</a>
                     </h3>
                     <div class="blog__meta">
                        <ul>
                           <li>
               ...
               <div class="col-xxl-6 col-xl-6 col-lg-6">
                  <div class="cta__item cta__item-border pt-40 pb-15 d-sm-flex align-items-start pr-110">
                     ...
                     <div class="cta__content">
                        ...
                        <a href="https://themepure.net/wp/dustrilox/contact/" class="tp-btn tp-btn-3">Start Teaching</a>
                     </div>
                  </div>
               </div>
               <div class="col-xxl-6 col-xl-6 col-lg-6">
                  <div class="cta__item pl-85 pt-40 pb-15 d-sm-flex align-items-start">
                     ...
                     <div class="cta__content">
                        ...
                        <a href="https://themepure.net/wp/dustrilox/contact/" class="tp-btn tp-btn-4">Apply Now</a>
                     </div>
                  </div>
               </div>
            </div>
