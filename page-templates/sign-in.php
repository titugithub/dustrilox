...
<main>
   ...
   <section class="signup__area p-relative z-index-1 pt-100 pb-145">
      <div class="sign__shape">
         <img class="man-1" src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/icon/sign/man-1.png" alt="img">
         <img class="man-2" src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/icon/sign/man-2.png" alt="img">
               ...
               <div class="sign__wrapper white-bg">
                  <div class="sign__header mb-35">
                     <div class="sign__in text-center">
                        ...
                        <p> <span>........</span> Or, <a href="#">sign in</a> with your email<span> ........</span> </p>
                     </div>
                  </div>
                  <div class="sign__form">
                     <form action="#">
                        ...
                        <div class="sign__new text-center mt-20">
                           <p>New to dustrilox? <a href="https://themepure.net/wp/dustrilox/sign-up/">Sign Up</a></p>
                        </div>
                     </form>
                  </div>
               </div>
