         ...
         <div class="row">
            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
               <div class="teacher__details-thumb p-relative pr-30">
                  <img class="team-thumb" src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/team/details/teacer-details-1.jpg" alt="img">
                  <div class="teacher__details-shape">
                     <img class="teacher-details-shape-1" src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/team/details/shape/shape-1.png" alt="img">
                     <img class="teacher-details-shape-2" src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri() ?>/assets/img/team/details/shape/shape-2.png" alt="img">
                  </div>
               </div>
            </div>
               ...
               <div class="teacher__wrapper">
                  ...
                  <div class="teacher__courses pt-55">
                     <div class="section__title-wrapper mb-30">
                        <h2 class="section__title">Teacher Course</h2>
                     </div>
