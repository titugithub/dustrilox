                  ...
                  <div class="col-xxl-12">
                     <div class="basic-pagination">
                        <nav>
                           <ul>
                              <li>
                                 <a href="https://themepure.net/wp/dustrilox/course-style-02/">
                                    <i class="far fa-angle-left"></i>
                                 </a>
                              </li>
                              <li>
                                 <a href="https://themepure.net/wp/dustrilox/course-style-02/">1</a>
                              </li>
                              <li>
                                 <span class="current">2</span>
                              </li>
                              <li>
                                 <a href="https://themepure.net/wp/dustrilox/course-style-02/">3</a>
                              </li>
                              <li>
