...
function dustrilox_register_required_plugins() {
    ...
    $plugins = [
        ...
        array(
            'name'               => esc_html__('Tutor LMS','dustrilox'),
            'slug'               => 'tutor',
            'required'           => true, 
        ),
        [
            ...
            'slug'         => 'tp-core',
            'source'       => esc_url( 'https://themepure.net/wp/dustrilox/source/tp-core.zip' ),
            'required'     => true,
            'external_url' => esc_url( 'https://themepure.net/wp/dustrilox/source/tp-core.zip' ),
        ],
        [
