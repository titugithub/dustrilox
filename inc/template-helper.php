...
function dustrilox_header_lang_defualt()
{
    ...
    if ($dustrilox_header_lang) : ?>
        ...
        <ul>
            <li><a href="javascript:void(0)" class="lang__btn"><?php print esc_html__('English', 'dustrilox'); ?> <i class="fa-light fa-angle-down"></i></a>
...
{ ?>
    <?php
        $dustrilox_logo_black = get_template_directory_uri() . '/assets/imgassets/img/logo/logo-black.png';
        $dustrilox_secondary_logo = get_theme_mod('seconday_logo', $dustrilox_logo_black);
        ?>
...
function dustrilox_mobile_logo()
{
    ...
    $dustrilox_site_logo = get_theme_mod('logo', get_template_directory_uri() . '/assets/imgassets/img/logo/logo.png');
...
/**
 * [dustrilox_category_menu description]
 * @return [type] [description]
 */
function dustrilox_category_menu()
{
    wp_nav_menu([
...
{
    $color_code = get_theme_mod('dustrilox_color_option', '#2b4eff');
    wp_enqueue_style('dustrilox-custom', DUSTRILOX_THEME_CSS_DIR . 'dustrilox-custom.css', []);
    if ($color_code != '') {
        $custom_css = '';
...
// theme color
function dustrilox_custom_color_primary()
{
    $color_code = get_theme_mod('dustrilox_color_option_2', '#f2277e');
    wp_enqueue_style('dustrilox-custom', DUSTRILOX_THEME_CSS_DIR . 'dustrilox-custom.css', []);
    if ($color_code != '') {
        $custom_css = '';
        $custom_css .= ".demo-class { background-color: " . $color_code . "}";
...
add_action('wp_enqueue_scripts', 'dustrilox_custom_color_primary');

// theme color
function dustrilox_custom_color_scrollup()
{
    $color_code = get_theme_mod('dustrilox_color_scrollup', '#2b4eff');
    wp_enqueue_style('dustrilox-custom', DUSTRILOX_THEME_CSS_DIR . 'dustrilox-custom.css', []);
    if ($color_code != '') {
        $custom_css = '';
        $custom_css .= ".demo-class { color: " . $color_code . "}";
...
add_action('wp_enqueue_scripts', 'dustrilox_custom_color_scrollup');

// theme color
function dustrilox_custom_color_secondary()
{
    $color_code = get_theme_mod('dustrilox_color_option_3', '#30a820');
    wp_enqueue_style('dustrilox-custom', DUSTRILOX_THEME_CSS_DIR . 'dustrilox-custom.css', []);
    if ($color_code != '') {
        $custom_css = '';
        $custom_css .= ".demo-class { background-color: " . $color_code . "}";
...
add_action('wp_enqueue_scripts', 'dustrilox_custom_color_secondary');

// theme color
function dustrilox_custom_color_secondary_2()
{
    $color_code = get_theme_mod('dustrilox_color_option_3_2', '#ffb352');
    wp_enqueue_style('dustrilox-custom', DUSTRILOX_THEME_CSS_DIR . 'dustrilox-custom.css', []);
    if ($color_code != '') {
        $custom_css = '';
        $custom_css .= ".demo-class { background-color: " . $color_code . "}";
...
add_action('wp_enqueue_scripts', 'dustrilox_custom_color_secondary_2');
