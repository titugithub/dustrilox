...
function dustrilox_customizer_panels_sections($wp_customize)
{
    ...
    $wp_customize->add_section('learndash_course_settings', [
        'title'       => esc_html__('Learndash Course Settings ', 'dustrilox'),
        'description' => '',
        'priority'    => 20,
        'capability'  => 'edit_theme_options',
        'panel'       => 'dustrilox_customizer',
...
function _header_top_fields($fields)
{
    ...
    $fields[] = [
        'type'     => 'text',
        'settings' => 'dustrilox_feed',
        'label'    => esc_html__('Feed', 'dustrilox'),
        'section'  => 'header_top_setting',
    ...
    $fields[] = [
        ...
        'label'    => esc_html__('delivery', 'dustrilox'),
        'section'  => 'header_top_setting',
    ...
    $fields[] = [
        'type'     => 'text',
        'settings' => 'dustrilox_delivery_link',
        'label'    => esc_html__('delivery link', 'dustrilox'),
        'section'  => 'header_top_setting',
        'default'  => esc_html__('#', 'dustrilox'),
        'priority' => 10,
    ];
    $fields[] = [
        ...
        'label'    => esc_html__('delivery link', 'dustrilox'),
        'section'  => 'header_top_setting',
        'default'  => esc_html__('Top Menu Set', 'dustrilox'),
        'priority' => 10,
    ];
...
function _header_footer_fields($fields)
{
    ...
    $fields[] = [
        ...
        'label'    => esc_html__('Footer Style 4 On/Off', 'dustrilox'),
        'section'  => 'footer_setting',
        'default'  => '0',
        'priority' => 10,
        'choices'  => [
    ...
    $fields[] = [
        ...
        'label'    => esc_html__('Copy Right', 'dustrilox'),
        'section'  => 'footer_setting',
...
// course_settings
function dustrilox_learndash_fields($fields)
{

    $fields[] = [
        'type'     => 'number',
        'settings' => 'dustrilox_learndash_post_number',
        'label'    => esc_html__('Learndash Post Per page', 'dustrilox'),
    ...
    $fields[] = [
        'type'        => 'select',
        'settings'    => 'dustrilox_learndash_order',
        'label'       => esc_html__('Post Order', 'dustrilox'),
        'section'     => 'learndash_course_settings',
        'default'     => 'DESC',
        'placeholder' => esc_html__('Select an option...', 'dustrilox'),
        'priority'    => 10,
        'multiple'    => 1,
        'choices'     => [
            'ASC' => esc_html__('ASC', 'dustrilox'),
            'DESC' => esc_html__('DESC', 'dustrilox'),
        ],
    ];

    $fields[] = [
        'type'     => 'switch',
        'settings' => 'dustrilox_learndash_related',
        'label'    => esc_html__('Show Related?', 'dustrilox'),
        'section'  => 'learndash_course_settings',
        'default'  => 1,
        'priority' => 10,
        'choices'  => [
...
if (class_exists('SFWD_LMS')) {
    add_filter('kirki/fields', 'dustrilox_learndash_fields');
}


// tutor_course_settings
function dustrilox_tutor_course_fields($fields)
{
    $fields[] = [
        'type'     => 'switch',
        'settings' => 'dustrilox_tutor_course_details_author_meta_switch',
        'label'    => esc_html__('Tutor Course Details Author Meta', 'dustrilox'),
    ...
    $fields[] = [
        'type'     => 'switch',
        'settings' => 'dustrilox_tutor_course_details_payment_switch',
        'label'    => esc_html__('Tutor Course Details Payment', 'dustrilox'),
        'section'  => 'tutor_course_settings',
        'default'  => '1',
        'priority' => 10,
        'choices'  => [
    ...
    $fields[] = [
        'type'     => 'switch',
        'settings' => 'dustrilox_tutor_course_desc_tab_switch',
        'label'    => esc_html__('Tutor Course Description Tab Swicher', 'dustrilox'),
        'section'  => 'tutor_course_settings',
        'default'  => '1',
        'priority' => 10,
        'choices'  => [
    ...
    $fields[] = [
        'type'     => 'switch',
        'settings' => 'dustrilox_tutor_course_curriculum_tab_switch',
        'label'    => esc_html__('Tutor Course Curriculum Tab Swicher', 'dustrilox'),
        'section'  => 'tutor_course_settings',
        'default'  => '1',
        'priority' => 10,
        'choices'  => [
    ...
    $fields[] = [
        'type'     => 'switch',
        'settings' => 'dustrilox_tutor_course_reviews_tab_switch',
        'label'    => esc_html__('Tutor Course Reviews Tab Swicher', 'dustrilox'),
        'section'  => 'tutor_course_settings',
        'default'  => '1',
        'priority' => 10,
        'choices'  => [
    ...
    $fields[] = [
        'type'     => 'switch',
        'settings' => 'dustrilox_tutor_course_instructor_tab_switch',
        'label'    => esc_html__('Tutor Course Instructor Tab Swicher', 'dustrilox'),
        'section'  => 'tutor_course_settings',
        'default'  => '1',
        'priority' => 10,
        'choices'  => [
...
if (function_exists('tutor')) {
    add_filter('kirki/fields', 'dustrilox_tutor_course_fields');
}
...
// course_settings
function dustrilox_course_fields($fields)
{

    $fields[] = [
        'type'        => 'radio-image',
        'settings'    => 'course_style',
        'label'       => esc_html__('Select Course Style', 'dustrilox'),
        'section'     => 'tutor_course_settings',
        'default'     => '5',
        'placeholder' => esc_html__('Select an option...', 'dustrilox'),
        'priority'    => 10,
    ...
    $fields[] = [
        ...
        'label'    => esc_html__('Show search?', 'dustrilox'),
        'section'  => 'tutor_course_settings',
        'default'  => '0',
        'priority' => 10,
        'choices'  => [
    ...
    $fields[] = [
        ...
        'label'    => esc_html__('Show latest post?', 'dustrilox'),
        'section'  => 'tutor_course_settings',
        'default'  => '0',
        'priority' => 10,
        'choices'  => [
    ...
    $fields[] = [
        ...
        'label'    => esc_html__('Show category filter?', 'dustrilox'),
        'section'  => 'tutor_course_settings',
        'default'  => '0',
        'priority' => 10,
        'choices'  => [
    ...
    $fields[] = [
        ...
        'label'    => esc_html__('Show skill filter?', 'dustrilox'),
        'section'  => 'tutor_course_settings',
        'default'  => '0',
        'priority' => 10,
        'choices'  => [
...
add_filter('kirki/fields', 'dustrilox_course_fields');
